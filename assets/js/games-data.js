...
const gamesData = [
    ...
    { id: 'shooting-007', name: '坦克大战', category: 'shooting', description: '驾驶坦克消灭敌人', tags: ['坦克', '射击', '对战'], difficulty: '中等', icon: '🛡️' },
    ...
    { id: 'sports-004', name: '网球', category: 'sports', description: '打网球', tags: ['网球', '反应', '对战'], difficulty: '中等', icon: '🎾' },
    { id: 'sports-005', name: '保龄球', category: 'sports', description: '打保龄球', tags: ['保龄球', '瞄准', '技巧'], difficulty: '简单', icon: '🎳' },
